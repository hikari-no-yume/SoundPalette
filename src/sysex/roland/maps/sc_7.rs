...
const SC_7_PAM_SYSTEM: ParameterAddressMap = &[
    ...
    param_simple(&[0x01], 0x01, "REVERB LEVEL", 0x00..=0x7F),
    param_simple(&[0x02], 0x01, "REVERB (DELAY) TIME", 0x00..=0x7F),
    param_simple(&[0x03], 0x01, "DELAY TIME", 0x00..=0x7F),
    param_simple(&[0x04], 0x01, "DELAY FEEDBACK", 0x00..=0x7F),
    param_simple(&[0x05], 0x01, "CHORUS LEVEL", 0x00..=0x7F),
    param_simple(&[0x06], 0x01, "CHORUS FEEDBACK", 0x00..=0x7F),
    param_simple(&[0x07], 0x01, "CHORUS DELAY", 0x00..=0x7F),
    param_simple(&[0x08], 0x01, "CHORUS RATE", 0x00..=0x7F),
    param_simple(&[0x09], 0x01, "CHORUS DEPTH", 0x00..=0x7F),
];
